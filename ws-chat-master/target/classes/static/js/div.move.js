...
(function () {
    function b(t, s) {
        ...
        this.cs = t.find(s.min_hide).first();
        this.m = false;
        this.s = false;
        this.hide = 5;
        this.size_bg = s.size;
    ...
    b.prototype = {
        ...
        leave: function (xx, yy) {
            var t = this;
            if (xx >= t.t.offset().left && xx <= t.t.offset().left + t.width && yy >= t.t.offset().top &&
        ...
        right_animate: function () {
            var t = this;
            t.t.animate({
                left: (t.w_width - t.hide)
            }, 300, function () {
                t.t.one('mouseenter', function () {
                    t.t.stop(true).animate({
                        left: t.w_width - t.width
                    }, 300);
                });
            });
        }
